...
$(document).ready(function() {
	...
	$('#demo-msk-date').mask('12/34/9999');
	$('#pacFecNac').mask('99/99/9999');
	$('#demo-msk-date2').mask('99-99-9999');
	$('#demo-msk-phone').mask('(999) 999-9999');
	$('#demo-msk-grade').mask('999°');
	$('#demo-msk-grade1').mask('999°');
	$('#demo-msk-taxid').mask('99-9999999');
	$('#demo-msk-ssn').mask('999-99-9999');
	$('#demo-msk-pkey').mask('a*-999-a999');
	$('#demo-msk-cedula').mask('999-9999999-9');
    $('#phonenumber').mask('999-999-9999');
	$('#demo-msk-cedula1').mask('999-9999999-9');
	$('#phonenumber1').mask('999-999-9999');
	$('#phonenumber2').mask('999-999-9999');
	$('#phonenumber3').mask('999-999-9999');
	$('#phonenumber4').mask('999-999-9999');
    $('#pacCell').mask('999-999-9999');
    $('#pacCasaa').mask('999-999-9999');
    $('#pacWhats').mask('999-999-9999');
